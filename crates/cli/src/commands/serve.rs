//! Serve a Komorei source as a local source list.
use axum::{
	Router,
...
pub async fn run(
	...
	tracing_subscriber::fmt()
		.with_target(false) // hide the `komorei_cli::commands::serve:` text
	...
	println!(
		"Add http://{}:{}/index.min.json as a source list in Komorei",
		local_ip_address, port
	);
