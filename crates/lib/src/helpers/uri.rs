...
/// # Examples
/// ```
/// use komorei::helpers::uri::encode_uri;
/// assert_eq!(
...
/// # Examples
/// ```
/// use komorei::helpers::uri::encode_uri_component;
/// assert_eq!(
...
/// # Examples
/// ```
/// use komorei::helpers::uri::decode_uri;
/// assert_eq!(
...
impl From<SerializeError> for KomoreiError {
